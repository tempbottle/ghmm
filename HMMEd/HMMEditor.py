...
class HMMErrorDialog(tkSimpleDialog.Dialog):
    ...
    def buttonbox(self):
        ...
        # standard buttons
        box = Frame(self)
        button_ok = Button(box, text="Ok", width=30, command=self.ok, default=ACTIVE)
        button_ok.pack(side=TOP, padx=5, pady=5)
        box.pack(side=BOTTOM,fill=X)
